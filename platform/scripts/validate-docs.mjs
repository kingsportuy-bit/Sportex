...
const requiredDocs = [
  ...
  'docs/INCIDENT_PREEMPTION_RECONCILIATION_CONTRACT.md',
  ...
  'docs/state/CAMPAIGN_STATE.json', 'docs/state/WORKTREE_CLASSIFICATIONS.json',
  'docs/state/INCIDENT_RECONCILIATION_STATE.json', 'docs/TASKS/README.md',
  ...
  'scripts/incident-reconciliation.mjs', 'scripts/tests/incident-reconciliation.test.mjs',
