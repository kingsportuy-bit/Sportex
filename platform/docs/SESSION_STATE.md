...
- Despliegues: `PILOTO_DELTA_8A83AC4_WHATSAPP_TABS_SIDEBAR_STYLE`; registros 21.
- Integraciones: GitHub=`REMOTE_CANDIDATE_72E0FC2_DEPLOYED_VERIFIED` | Supabase=`PILOTO_DELTA_19_TABLAS_RLS_FORZADO_MEDIA_UNREAD_006` | Evolution API=`DELTA_OPEN_UPSERT_UPDATE_BASE64_ACTIVE_MANUAL_OUTBOUND_ON` | VPS / runtime=`PILOTO_DELTA_RUNTIME_8A83AC4_PUBLIC_HEALTHY`
...
- Pestañas de WhatsApp con estilo lateral, texto horizontal y bracket curvo desplegadas; sin mensajes.
